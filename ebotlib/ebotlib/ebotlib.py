...
class EBot:
    ...
    #serial port can be regular tty port or usb tty port
        ...
        if os.name == "posix":
            if sys.platform == "linux2":
                ...
                while(line != "&\n" and line != "&"):
                    for i in range(len(usbSerial)):
                        ...
                        line = self.openingbluetoothports(settings.SERIAL_PORT_NAME)
                        print line
                        if (line == "&\n" or line == "&"):
                            break
            else:
            ...
            AMIGO_PORTS = self.getAmigoPorts()
...
################################################################################
    ...
    def openingbluetoothports(self,port_name):
